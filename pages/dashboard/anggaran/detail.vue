                ...
                <div class="card">
                    <div class="card__header">
                        <div class="card__header--info">
                            <NuxtLink to="/dashboard/anggaran" class="card__header--back btn-ghost-circle">
                        ...
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu">
                                <NuxtLink to="/dashboard/tujuan/tambah">Edit</NuxtLink>
                                <NuxtLink to="/dashboard/tujuan/">Delete</NuxtLink>
                            </div>  
                        </div>
                    </div>
                        ...
                        <div class="deposit">
                            <div class="deposit__item">
                                ...
                                <div class="deposit__body">
                                    <NuxtLink to="/dashboard/transaksi/detail" class="deposit__body--content">
