        ...
        <Drawer>
            ...
            <center>
                <div class="main-content">
                    <NuxtLink to="/dashboard/profil/kelola" class="baris-content">
                    ...
                    <NuxtLink to="/dashboard/dompet" class="baris-content">
                        <div class="content-kiri">
                            <svg width="32" height="32" viewBox="0 0 24 24">
                    ...
                    <NuxtLink to="/dashboard/profil/pengaturan" class="baris-content">
                        <div class="content-kiri">
                            <svg width="32" height="32" viewBox="0 0 24 24">
                    ...
                    <NuxtLink to="https://www.customercare.co.nz/" class="baris-content">
                        <div class="content-kiri">
                            <svg width="32" height="32" viewBox="0 0 24 24">
                    ...
                    <div class="keluar">
                        <NuxtLink to="/" class="btn-danger">Keluar</NuxtLink>
                    </div>
                </div>
            </center>
        </Drawer>
