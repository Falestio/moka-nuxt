    ...
    <div>
        <Drawer>
            ...
            <div class="div-trans">
                <div class="trans1">
                    <div class="isi-trans">
                        ...
                        <div class="isi-trans2-1">Rp. 36.230.000</div>
                        <br />
                ...
                <div class="trans2">
                    <div class="isi-trans">
                        ...
                        <div class="isi-trans2-2">Rp. 37.550.000</div>
                        <br />
                ...
                <div class="trans3">
                    <div class="isi-trans">
                        ...
                        <div class="isi-trans2-3">Rp. 1.320.000</div>
                        <br />
            ...
            <NuxtLink to="/dashboard/transaksi/detail" id="detail">
                ...
                <div id="tolbul-detail">-Rp.60.000</div>
            </NuxtLink>
            <NuxtLink to="/dashboard/transaksi/detail" id="detail">
                <div id="subjudul-detail">
                    <svg class="detail-icon" width="20" height="20" viewBox="0 0 24 24">
                ...
                <div id="tolbul-detail">-Rp. 140.000</div>
            </NuxtLink>
            <NuxtLink to="/dashboard/transaksi/detail" id="detail">
                <div id="subjudul-detail">
                    <svg class="detail-icon" width="20" height="20" viewBox="0 0 24 24">
                ...
                <div id="tolbul-detail">-Rp. 240.000</div>
            </NuxtLink>
            <hr />
            <div id="Pendapatan">
                <div id="subjudul">
