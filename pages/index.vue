    ...
    <div>
            ...
            <nav class="nav">
                ...
                <div class="nav__menu">
                    <div class="nav__menu-links-wrapper">
                        ...
                        <NuxtLink to="/daftar" class="nav__menu-link btn">Coba Gratis</NuxtLink>
                        <NuxtLink to="/masuk" class="nav__menu-link">Masuk</NuxtLink>
                    </div>
        ...
        <main class="main">
            <div class="main__headline">
                ...
                <NuxtLink to="/daftar" class="main__headline-cta btn">Coba Gratis</NuxtLink>
            </div>
            ...
            <div class="main__benefit-1 container">
                ...
                <div class="main__benefit-1-content">
                    ...
                    <p class="main__benefit-1-content-text">It takes seconds to record daily transactions. Put them into clear and visualized categories such as Expense: Food, Shopping or Income: Salary, Gift.</p>
                </div>
            </div>
            ...
            <div class="main__cta">
                <div class="main__cta-wrapper container">
                    ...
                    <NuxtLink to="/daftar" class="main__cta-link btn">Coba Gratis</NuxtLink>
                </div>
            </div>
        </main>
    </div>
